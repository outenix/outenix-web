...
<nav class="header print:hidden">
    ...
    <div class="header-container relative flex w-full bg-white dark:bg-navy-750 print:hidden">
        ...
        <div class="flex w-full items-center justify-between">
            <!-- Tombol hanya muncul di perangkat mobile -->
            ...
            <div class="-mr-1.5 flex w-full items-center space-x-2 {{ !request()->routeIs('dashboard') ? 'justify-end' : '' }}">
                @if (request()->routeIs('dashboard'))
                    <div class="flex w-full items-center justify-between">
                        <button
                            class="btn bg-slate-150 space-x-2 text-xs font-semibold text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-">
                            <img class="h-5 w-5" src="{{ asset('images/socials/telegram.png') }}" alt="logo" />
                    ...
                    <div class="flex" x-data="usePopper({ placement: 'bottom-end', offset: 12 })" @click.outside="if(isShowPopper) isShowPopper = false">
                        <div class="relative flex h-8">
                            <input placeholder="Search here..."
                                class="form-input peer h-full rounded-lg bg-slate-150 px-4 pl-9 text-xs+ text-slate-800 ring-primary/50 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:text-navy-100 dark:placeholder-navy-300 dark:ring-accent/50 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                ...
                <button
                @click="
                    $store.global.isDarkModeEnabled = !$store.global.isDarkModeEnabled
                "
                ...
                <!-- <button @click="$store.global.isMonochromeModeEnabled = !$store.global.isMonochromeModeEnabled"
                    class="btn relative h-8 w-8 rounded-full p-1 px-2 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    <i
                        class="fa-solid fa-palette bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-lg"></i>
                </button> -->
