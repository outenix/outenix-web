    ...
    <div
        ...
        <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <a href="{{ route('dashboard') }}"
                ...
                <i class="fa-duotone fa-solid fa-house-fire fa-xl"></i>
            </a>

            <!-- Avatars -->
            <a href="{{ route('avatars') }}"
                class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 {{ $routePrefix === 'avatars' ? 'text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 bg-primary/10 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90' : 'hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25' }}"
                x-tooltip.placement.right="'Avatars'">
                <i class="fa-duotone fa-solid fa-user-tie-hair fa-xl"></i>
            </a>
            ...
            <a href="{{ route('apps/list') }}"
                ...
                <i class="fa-duotone fa-solid fa-rocket fa-xl"></i>
            </a>
        ...
        <div class="flex flex-col items-center space-y-3 py-3">
            ...
            <a href="{{ route('settings') }}"
                ...
                <i class="fa-duotone fa-solid fa-gear fa-xl"></i>
            </a>
            ...
            <div x-data="usePopper({ placement: 'right-end', offset: 12 })" @click.outside="if(isShowPopper) isShowPopper = false" class="flex">
                <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar h-12 w-12">
                    <img class="rounded-full" src="{{ asset('images/avatars/' . $account['account_data']->profile_picture . '.png') }}" alt="avatar" />
                    <span
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-4 rounded-t-lg bg-slate-100 py-5 px-4 dark:bg-navy-800">
                            <div class="avatar h-14 w-14">
                                <img class="rounded-full" src="{{ asset('images/avatars/' . $account['account_data']->profile_picture . '.png') }}"
                                    alt="avatar" />
                            </div>
                            <div>
                                <a href="#"
                                    class="text-base font-medium line-clamp-1 text-slate-700 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                                    {{ ucwords($account['account_data']->name) }}
                                </a>
                                <p class="text-xs text-slate-400 dark:text-navy-300">
                                {{ ucwords($account['account_data']->status) }}
                                </p>
                            </div>
                        </div>
