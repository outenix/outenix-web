<x-app-layout title="Avatars" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div
            ...
            <div>
                ...
                <p class="mt-1 hidden sm:block">Sesuaikan avatar kamu, avatar ini akan tampil di profile apabila seseorang mengunjungi profilemu</p>
            </div>
            <div>
                ...
                <div class="mt-2 flex space-x-2">
                    <div class="avatar h-8 w-8">
                        <img class="mask is-squircle" src="{{ asset('images/100x100.png') }}" alt="avatar" />
                    </div>
                    <div class="avatar h-8 w-8">
                        <img class="mask is-squircle" src="{{ asset('images/100x100.png') }}" alt="avatar" />
                    </div>
        ...
        <div class="mt-4">
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
                @foreach ($avatars as $avatarPack => $avatarGroup)
                <!-- Awal kelompok -->
                <div class="card justify-between p-4 sm:p-5 mb-6">
                    <div class="flex items-center space-x-3">
                        <img class="h-10 w-10 shrink-0 rounded-full object-cover"
                            src="{{ asset('images/avatars/' . $avatarGroup->first()->avatar_code . '.png') }}" alt="image" />
                        <div>
                            <div class="flex items-center justify-between space-x-2">
                                <div><h3 class="text-base font-medium">{{ $avatarPack }}</h3></div>
                                <div>
                                <button
                            ...
                            <p class="text-xs">
                                <a
                                    href="#"
                                    class="tag rounded bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90"
                                >
                                    {{ $avatarGroup->count() }} Avatar
                                </a>
                            </p>
                        </div>
                    </div>
                    <div class="mt-3">
                        <div class="mt-3 grid grid-cols-4 gap-4">
                            <!-- Tampilkan gambar berdasarkan avatar_pack -->
                            @foreach ($avatarGroup->take(8) as $avatar)
                                <div class="text-center">
                                    <div class="avatar h-10 w-10">
                                        <img class="rounded-full" src="{{ asset('images/avatars/' . $avatar->avatar_code . '.png') }}" alt="avatar" />
                                    </div>
                                </div>
                            @endforeach
                            <!-- Akhir tampil -->
