<x-app-layout title="User Card 2" is-header-blur="true">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser1);
                                $el._x_chart.render()
                            });"></div>
                        </div>
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser2);
                                $el._x_chart.render()
                            });"></div>
                        </div>
                        <div class="w-3/12 text-center">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser3);
                                $el._x_chart.render()
                            });"></div>
                        </div>
                        <div class="w-3/12 text-center">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser4);
                                $el._x_chart.render()
                            });"></div>
                        </div>
                        <div class="w-3/12 text-center">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <p class="text-xs">Germany, Berlin</p>
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser5);
                                $el._x_chart.render()
                            });"></div>
                        </div>
                        <div class="w-3/12 text-center">
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <p class="text-xs">Sweden, Stockholm</p>
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser1);
            ...
            <div class="card">
                ...
                <div class="px-4 py-2 sm:px-5">
                    ...
                    <p class="text-xs">Switzerland, Zurich</p>
                    <div class="flex items-center space-x-4 pt-2">
                        <div class="w-9/12">
                            <div class="ax-transparent-gridline" x-init="$nextTick(() => {
                                $el._x_chart = new ApexCharts($el, pages.charts.cardUser2);
