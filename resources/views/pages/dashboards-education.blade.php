                ...
                <div class="swiper-wrapper">
                    <div
                        ...
                        <div>
                            ...
                            <a href="#"
                                class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Konnor
                                Guzman</a>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <a href="#"
                                class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Eric
                                Fox</a>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <a href="#"
                                class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Travis
                                Fuller</a>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <a href="#"
                                class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Derrick
                                Simmons</a>
                        </div>
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <a href="#"
                                class="mt-0.5 text-xs+ text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100">Katrina
                                West</a>
                        </div>
            ...
            <div
                ...
                <div class="card justify-between p-5">
                    ...
                    <div class="flex items-center justify-between pt-4">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-10 w-10 text-secondary dark:text-secondary-light" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="card justify-between p-5">
                    ...
                    <div class="flex items-center justify-between pt-4">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-success" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="mt-4 space-y-4 sm:mt-5 lg:mt-6">
                    <div class="card p-4">
                        <div class="flex items-center space-x-3">
                            <div>
                                <img class="h-10 w-10" src="{{ asset('images/awards/award-31.svg') }}"
                                    alt="image" />
                            </div>
                            <div>
                                <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    ...
                    <div class="card p-4">
                        <div class="flex items-center space-x-3">
                            <div>
                                <img class="h-10 w-10" src="{{ asset('images/awards/award-27.svg') }}"
                                    alt="image" />
                            </div>
                            <div>
                                <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    ...
                    <div class="card p-4">
                        <div class="flex items-center space-x-3">
                            <div>
                                <img class="h-10 w-10" src="{{ asset('images/awards/award-5.svg') }}"
                                    alt="image" />
                            </div>
                            <div>
                                <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                    ...
                    <div class="card p-2.5">
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    <a href="#"
                                        class="font-medium text-slate-700 outline-none transition-colors line-clamp-2 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Learn
                    ...
                    <div class="card p-2.5">
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    <a href="#"
                                        class="font-medium text-slate-700 outline-none transition-colors line-clamp-2 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Basic
                    ...
                    <div class="card p-2.5">
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    <a href="#"
                                        class="font-medium text-slate-700 outline-none transition-colors line-clamp-2 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">Sales
