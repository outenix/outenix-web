        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2">
                        <div class="avatar h-8 w-8">
                            <div class="is-initial rounded-full bg-secondary text-xs+ uppercase text-white">
                                TS
                            </div>
                        </div>
                        <div class="avatar h-8 w-8">
            ...
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2">
                        ...
                        <div class="avatar h-8 w-8">
                            <div class="is-initial rounded-full bg-success text-xs+ uppercase text-white">
                                Io
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2">
                        ...
                        <div class="avatar h-8 w-8">
                            <div
                                class="is-initial rounded-full border border-success/30 bg-success/10 text-xs+ uppercase text-success">
                                tr
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2">
                        ...
                        <div class="avatar h-8 w-8">
                            <div class="is-initial rounded-full bg-warning text-xs+ uppercase text-white">
                                tr
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="flex flex-col items-center p-4 text-center sm:p-5">
                    ...
                    <div class="my-3.5 flex flex-wrap space-x-2">
                        ...
                        <div class="avatar h-8 w-8">
                            <div
                                class="is-initial rounded-full border border-info/30 bg-info/10 text-xs+ uppercase text-info">
                                ds
                            </div>
                        </div>
                    </div>
