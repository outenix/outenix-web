<x-app-layout title="Employees Dashboard" is-header-blur="true">
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="card shadow-none">
                ...
                <div class="ax-transparent-gridline ax-rounded-b-lg">
                    <div x-init="$nextTick(() => {
                        $el._x_chart = new ApexCharts($el, pages.charts.clientsGrowth);
                        $el._x_chart.render()
                    });"></div>
                </div>
            </div>
            <div class="card shadow-none">
                ...
                <div class="ax-transparent-gridline ax-rounded-b-lg">
                    <div x-init="$nextTick(() => {
                        $el._x_chart = new ApexCharts($el, pages.charts.salesGrowth);
                        $el._x_chart.render()
                    });"></div>
                </div>
            </div>
            <div class="card flex-row justify-between p-4 sm:flex-col lg:flex-row">
                ...
                <div class="flex items-center justify-center">
                    <div x-init="$nextTick(() => {
                        $el._x_chart = new ApexCharts($el, pages.charts.employeesTask);
                        $el._x_chart.render()
                    });"></div>
                </div>
            </div>
