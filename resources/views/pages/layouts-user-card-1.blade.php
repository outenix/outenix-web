    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-reuleaux-triangle " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Katrina West
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-diamond " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Raul Bradley
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-hexagon " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Samantha Shelton
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-hexagon-2 " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Corey Evans
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-star " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Lance Tucker
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-star-2 " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Anthony Jensen
                    </h3>
            ...
            <div class="card">
                ...
                <div class="flex grow flex-col items-center px-4 pb-5 sm:px-5">
                    <div class="avatar h-20 w-20">
                        <img class="mask is-octagon " src="{{asset('images/100x100.png')}}" alt="avatar" />
                    </div>
                    <h3 class="pt-3 text-lg font-medium text-slate-700 dark:text-navy-100">
                        Joe Perkins
                    </h3>
