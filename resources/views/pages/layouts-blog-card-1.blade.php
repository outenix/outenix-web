<x-app-layout title="Blog Card 1" is-header-blur="true">
                ...
                <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                    ...
                    <div class="grow">
                        <div class="mt-2 flex items-center text-xs">
                            ...
                            <div class="mx-3 my-1 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <span class="shrink-0 text-slate-400 dark:text-navy-300">December 27, 2021</span>
                        </div>
                    </div>
                    <div class="mt-1 flex justify-end">
                        <a href="#"
                ...
                <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                    ...
                    <div class="grow">
                        <div class="mt-2 flex items-center text-xs">
                            ...
                            <div class="mx-3 my-1 w-px self-stretch bg-slate-200 dark:bg-navy-500"></div>
                            <span class="shrink-0 text-slate-400 dark:text-navy-300">November 9, 2021</span>
                        </div>
                    </div>
                    <div class="mt-1 flex justify-end">
                        <a href="#"
